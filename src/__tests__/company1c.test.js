...
describe('detect if file path is webpack chunk', () => {
  it('should return true, because double hash is at end', () => {
    const filePath =
      'https://dhmmnd775wlnp.cloudfront.net/3398189b92/js/apps/dist/234eecb673c7c303f4cf-2fa~apps~authentication~beacons~connection-settings~custom-fields~customer-profile~customers~dashboa~234eecb6-234eecb6.js'
    expect(
